    ...
    renderFlow(flow) {
        ...
        flow.steps.forEach(step => {
            ...
            if (step.type === 'branching-prompt') {
                outputConnectors = `<div class="connector-group"><div class="connector bottom" data-id="${step.id}" data-type="out" data-output-name="pass" data-label="Pass"></div><div class="connector bottom" data-id="${step.id}" data-type="out" data-output-name="fail" data-label="Fail"></div></div>`;
            }
