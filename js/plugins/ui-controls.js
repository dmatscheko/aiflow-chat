...
export const messageModificationPlugin = {
    ...
    hooks: {
         ...
         * @param {import('../components/chat-ui-manager.js').ChatUIManager} chatUIManager - The Chat UI Manager.
         */
        onRenderMessageControls: function(container, message, chatlog, chatbox, chatUIManager) {
            ...
            const editBtn = createControlButton(
                ...
                () => {
                    ...
                    chatUIManager.setMessageToEditMode(message);
            ...
            const delBtn = createControlButton(
                ...
                () => {
                    ...
                    chatUIManager.deleteMessage(message, true);
                }
            );
