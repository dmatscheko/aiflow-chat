...
export class ApiService {
    ...
    /**
     * Initiates a non-streaming chat completions request to the API.
     * @param {object} payload - The payload to send to the API (e.g., { model, messages, stream: false }).
     * @param {string} apiUrl - The base URL of the API.
     * @param {string} apiKey - The user's API key.
     * @param {AbortSignal} abortSignal - The abort signal to cancel the request.
     * @returns {Promise<object>} A promise that resolves to the complete JSON response from the API.
     * @throws {Error} If the API request fails or is aborted.
     */
    async getCompletion(payload, apiUrl, apiKey, abortSignal) {
