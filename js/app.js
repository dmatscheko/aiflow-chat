...
import { ToolCallService } from './services/tool-call-service.js';
...
class App {
    constructor() {
        ...
        this.toolCallService = new ToolCallService(this.uiManager);
     ...
     */
    registerPlugins() {
        registerPlugin(agentsPlugin, this, this.toolCallService);
        registerPlugin(mcpPlugin, this, this.toolCallService);
